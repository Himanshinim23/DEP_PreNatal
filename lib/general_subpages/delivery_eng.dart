...
class delivery_eng extends StatefulWidget {
  @override
  _Diet_pre createState() => _Diet_pre();

}

class _Diet_pre extends State<delivery_eng> {
          ...
          Row(
            ...
            children: [
              Container(
                ...
                child: Text("Delivery preparedness ",
            ...
            children: [
              SingleChildScrollView(
                child: Container(
                  ...
                  child: Text("● Decide the place of delivery after consulting your PHC doctor/ANM/ASHA. \n\n● You may have to go to the hospital even at night so make sure you have the essential mode of transport or 24X7 free ambulance service provided by dialling 108 from your phone. \n\n● Carry all your pregnancy records, ultrasound, and blood reports to hospital.\n\n● Arrange a bag of essential items for childbirth that includes hospital documents, old bed sheets, clean cotton clothes for you and your baby, extra pairs of undergarments, clean towel old bed sheets.",
    style: TextStyle(fontSize: 17)),
                ),
              )
            ],
