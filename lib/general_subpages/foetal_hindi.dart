...
class foetal_hindi extends StatefulWidget {
  @override
  _Diet_pre createState() => _Diet_pre();

}

class _Diet_pre extends State<foetal_hindi> {
            ...
            children: [
              SingleChildScrollView(
                child: Container(
                  ...
                  child: Text("●शिशु की हलचल जो आप अपने पेट में महसूस करती हैं, वह शिशु के सक्रिय और स्वस्थ होने का संकेत है.\n\n ●आप इसे जांचने और इसकी भलाई सुनिश्चित करने के लिए सबसे अच्छे मार्गदर्शक हैं। इसलिए, विशेष रूप से गर्भावस्था के 8वें महीने के बाद इसके बारे में सतर्क रहना आवश्यक है. \n\n●बच्चे की गतिविधियों को गिनने का सही तरीका खाना खाने के बाद एक घंटे के लिए अपनी बाईं ओर लेटना है और यह गिनना है कि बच्चा कितनी बार चलता है।. \n\n●पर्याप्त हलचलें एक घंटे में 3 या पूरे दिन में 10 हैं. \n\n●जब भी आपको लगे कि गतिविधि अपर्याप्त है, यानी 3 घंटे से कम, तो तुरंत अपने चिकित्सक/स्वास्थ्यकर्मी से परामर्श करें. ",
                      style: TextStyle(fontSize: 17)),
                ),
              )
            ],
