...
class covid_pun extends StatefulWidget {
  @override
  _Diet_pre createState() => _Diet_pre();

}

class _Diet_pre extends State<covid_pun> {
            ...
            children: [
              SingleChildScrollView(
                child: Container(
                  ...
                  child: Text(" ਜਿਵੇਂ ਕਿ ਤੁਸੀਂ ਸਾਰੇ ਜਾਣਦੇ ਹੋ, ਪਿਛਲੇ 2 ਸਾਲਾਂ ਤੋਂ ਕੋਵਿਡ ਦੀ ਲਾਗ ਸਾਡੇ ਭਾਈਚਾਰਿਆਂ ਵਿੱਚ ਵਾਰ-ਵਾਰ ਆ ਰਹੀ ਹੈ। ਤੁਹਾਨੂੰ ਉੱਥੇ ਕੁਝ ਬੁਨਿਆਦੀ ਸਫਾਈ ਅਭਿਆਸਾਂ ਦੀ ਪਾਲਣਾ ਕਰਕੇ ਆਪਣਾ ਧਿਆਨ ਰੱਖਣਾ ਚਾਹੀਦਾ ਹੈ ਜਿਵੇਂ ਕਿ \n\n●	ਜਦੋਂ ਤੁਸੀਂ ਆਪਣੇ ਘਰ ਤੋਂ ਬਾਹਰ ਹੁੰਦੇ ਹੋ ਜਾਂ ਤੁਹਾਡੇ ਨਾਲ ਨਹੀਂ ਰਹਿੰਦੇ ਲੋਕਾਂ ਦੀ ਮੌਜੂਦਗੀ ਵਿੱਚ ਮਾਸਕ ਪਹਿਨਣਾ.\n\n●	ਆਪਣੇ ਹੱਥਾਂ ਨੂੰ ਵਾਰ-ਵਾਰ ਸਾਬਣ ਅਤੇ ਪਾਣੀ ਨਾਲ ਧੋਵੋ/ ਹੈਂਡ ਸੈਨੀਟਾਈਜ਼ਰ ਦੀ ਵਰਤੋਂ ਕਰੋ।\n\n●	ਖੰਘਦੇ ਜਾਂ ਛਿੱਕਦੇ ਸਮੇਂ ਆਪਣੇ ਮੂੰਹ ਅਤੇ ਨੱਕ ਨੂੰ ਸਾਫ਼ ਸੂਤੀ ਕੱਪੜੇ ਨਾਲ ਜਾਂ ਆਪਣੀ ਕੂਹਣੀ ਨਾਲ ਢੱਕੋ।\n\n●	Maintain social distancing, that is 6 feet apart.\n\n●	ਲੱਛਣਾਂ ਵਾਲੇ ਵਿਅਕਤੀਆਂ ਦੇ ਸੰਪਰਕ ਤੋਂ ਬਚੋ ਜਿਵੇਂ ਕਿ ਬੁਖਾਰ, ਖੰਘ, ਜ਼ੁਕਾਮ।\n\n●	ਜਨਮ ਤੋਂ ਪਹਿਲਾਂ ਦੀ ਦੇਖਭਾਲ ਲਈ ਆਪਣੇ ਨਿਯਮਤ ਫਾਲੋ-ਅੱਪ ਨੂੰ ਨਾ ਭੁੱਲੋ। ਜੇਕਰ ਤੁਹਾਨੂੰ ਖੰਘ, ਬੁਖਾਰ ਜਾਂ ਸਾਹ ਚੜ੍ਹਦਾ ਹੈ, ਤਾਂ ਤੁਰੰਤ ਆਪਣੇ ਡਾਕਟਰ ਨਾਲ ਸੰਪਰਕ ਕਰੋ.",
                      style: TextStyle(fontSize: 17)),
                ),
              )
            ],
