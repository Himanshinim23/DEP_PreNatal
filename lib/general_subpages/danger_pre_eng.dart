...
class danger_eng extends StatefulWidget {
  @override
  _Diet_pre createState() => _Diet_pre();

}

class _Diet_pre extends State<danger_eng> {
          ...
          Row(
            ...
            children: [
              Container(
                ...
                child: Text(" Danger signs to watch out for  ",
            ...
            children: [
              SingleChildScrollView(
                child: Container(
                  ...
                  child: Text("If you notice any one of the following signs, you should immediately inform ASHA/ANM or visit a medical officer: \n\n●Severe pain in abdomen\n\n●Vaginal bleeding \n\n●Leaking before 9 months or due date of delivery\n\n●Severe headache, high BP (PIH)\n\n●Blurring of vision convulsions/fits, decreased or no foetal movements.\n\nThese signs are serious, and if ignored you or your baby may be at risk.",
    style: TextStyle(fontSize: 17)),
                ),
              )
            ],
