...
class danger_post extends StatefulWidget {
  @override
  _Diet_pre createState() => _Diet_pre();

}

class _Diet_pre extends State<danger_post> {
          ...
          Row(
            ...
            children: [
              Container(
                ...
                child: Text(" 1.Early Danger signs after \n   delivery  ",
            ...
            children: [
              SingleChildScrollView(
                child: Container(
                  ...
                  child: Text("●Vaginal bleeding after delivery is common for about 6 weeks. However, pay close attention to the amount of blood that is being lost because losing too much blood is dangerous.\n\n● If you fully soak more than one pad per hour for two or more hours or use more than 6 pads total per day please inform your ASHA/ANM or visit a medical officer.\n\n● Be alert in case of an infection, high blood pressure, or blood clots.\n\n● Signs of infection include fever with chills, foul smelling discharge from vagina (lochia), infected stitch line (perineal/C-section), painful breasts with redness, burning sensation while urination etc.\n\n● Symptoms of high blood pressure include severe headache, blurred vision, vomiting, reduced urine, generalized swelling, dizziness, and fits\n\n● Symptoms of blood clotting/embolization include swelling of legs, redness, and severe pain on walking or pressing the legs, or chest discomfort. ",
          ...
          Row(
            ...
            children: [
              Container(
                ...
                child: Text(" 2.Danger signs (delayed)  ",
                    style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold)),
              )
            ],
          ),
            ...
            children: [
              SingleChildScrollView(
                child: Container(
                  ...
                  width: MediaQuery.of(context).size.width*0.9,
                  child: Text(" ●	Danger signs are generally more common in the period immediately following delivery as explained earlier. But sometimes they persist for a longer period, you should not ignore them.\n\n● For e.g. persistent headache/ backache esp. if you had C-section with spinal anaesthesia (spinal headache), headache could also be because of high BP esp. if you had (PIH) (Pregnancy induced hypertension) in the antenatal or intra-partum period, foul smelling vaginal discharge (endometritis), persistent bleeding, fever off and no, excessive tiredness, persisting hypothyroidism if it developed during pregnancy or was present in the pre pregnant period also etc.\n\n● You may also need to have some blood tests done. Discuss these issues with your health care worker/ANM/ASHA. You may also directly contact your doctor.\n\n● Don’t miss out on the postpartum visits that doctors had advised if you had institutional delivery/C-section.",
