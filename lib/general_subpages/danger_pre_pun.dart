...
class danger_pun extends StatefulWidget {
  @override
  _Diet_pre createState() => _Diet_pre();

}

class _Diet_pre extends State<danger_pun> {
          ...
          Row(
            ...
            children: [
              Container(
                ...
                child: Text(" ਦੇਖਣ ਲਈ ਖ਼ਤਰੇ ਦੇ ਚਿੰਨ੍ਹ ",
            ...
            children: [
              SingleChildScrollView(
                child: Container(
                  ...
                  child: Text("ਜੇਕਰ ਤੁਸੀਂ ਹੇਠਾਂ ਦਿੱਤੇ ਲੱਛਣਾਂ ਵਿੱਚੋਂ ਕੋਈ ਇੱਕ ਦੇਖਦੇ ਹੋ, ਤਾਂ ਤੁਹਾਨੂੰ ਤੁਰੰਤ ਆਸ਼ਾ/ਏਐਨਐਮ ਨੂੰ ਸੂਚਿਤ ਕਰਨਾ ਚਾਹੀਦਾ ਹੈ ਜਾਂ ਕਿਸੇ ਮੈਡੀਕਲ ਅਫ਼ਸਰ ਨੂੰ ਮਿਲਣਾ ਚਾਹੀਦਾ ਹੈ: \n\n●ਪੇਟ ਵਿੱਚ ਗੰਭੀਰ ਦਰਦ\n\n●ਯੋਨੀ ਵਿੱਚੋਂ ਖੂਨ ਨਿਕਲਣਾ \n\n●9 ਮਹੀਨਿਆਂ ਤੋਂ ਪਹਿਲਾਂ ਜਾਂ ਕਾਰਨ ਦਾ ਲੀਕ ਹੋਣਾ। ਜਣੇਪੇ ਦੀ ਮਿਤੀ\n\n●ਗੰਭੀਰ ਸਿਰ ਦਰਦ, ਉੱਚ ਬੀ.ਪੀ. (PIH)\n\n●ਦਰਸ਼ਨ ਦਾ ਧੁੰਦਲਾਪਨ/ਫਿੱਟ ਹੋਣਾ, ਘਟਣਾ ਜਾਂ ਗਰੱਭਸਥ ਸ਼ੀਸ਼ੂ ਦੀ ਕੋਈ ਹਿਲਜੁਲ ਨਹੀਂ।\n\nਇਹ ਸੰਕੇਤ ਗੰਭੀਰ ਹਨ, ਅਤੇ ਜੇਕਰ ਤੁਸੀਂ ਜਾਂ ਤੁਹਾਡੇ ਬੱਚੇ ਨੂੰ ਅਣਡਿੱਠ ਕੀਤਾ ਗਿਆ ਤਾਂ ਹੋ ਸਕਦਾ ਹੈ ਖਤਰੇ ਵਿੱਚ ਹੋਣਾ।",        style: TextStyle(fontSize: 17)),
                ),
              )
            ],
          ),
