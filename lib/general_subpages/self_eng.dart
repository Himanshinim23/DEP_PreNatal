...
class self_eng extends StatefulWidget {
  @override
  _Diet_pre createState() => _Diet_pre();

}

class _Diet_pre extends State<self_eng> {
          ...
          Row(
            ...
            children: [
              Container(
                ...
                child: Text(" 1.Psychological issues and fears",
            ...
            children: [
              SingleChildScrollView(
                child: Container(
                  ...
                  child: Text(" ‣ For good mental wellbeing: -\n\n●	Clear your doubts about pregnancy, new-born baby etc from the health care worker.\n\n●	Remain physically active and eat regular healthy meals and take adequate sleep.\n\n●	Spend time with people who make you feel positive.\n\n●	Connect with other expectant mothers and support groups.\n\n●	Don’t feel alone and ask for help from your near ones if you need.\n\n●	Contact your health care worker if you feel persistently low (e.g. sad or worried) for more than 2 weeks, have negative thoughts, feelings, symptoms of anxiety, depression, losing interest in work and pleasurable activities, feeling hopeless or unable to cope up with the current situation.",
    style: TextStyle(fontSize: 17)),
                ),
              )
            ],
          ...
          Row(
            ...
            children: [
              Container(
                ...
                child: Text(" 2.Maternal hygiene & self-care",
                    style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold)),
              )
            ],
          ),
            ...
            children: [
              SingleChildScrollView(
                child: Container(
                  ...
                  width: MediaQuery.of(context).size.width*0.9,
                  child: Text(" ●	Wash your hands with soap and water before and after every meal and after using   the toilet.\n\n●	Clip and clean your nails regularly.\n\n●	Take a proper bath along with head wash as per your routine.\n\n●	Take 8 hours of sound sleep at night and 2 hours rest during the day, lying preferably on your left side.",
    style: TextStyle(fontSize: 17)),
                ),
              )
            ],
          ...
          Row(
            ...
            children: [
              Container(
                ...
                child: Text(" 3.Sensitization towards \nresponsibility as an expectant/\nnew mother ",
                    style: TextStyle(fontSize: 17,fontWeight: FontWeight.bold)),
              )
            ],
          ),
            ...
            children: [
              SingleChildScrollView(
                child: Container(
                  ...
                  width: MediaQuery.of(context).size.width*0.9,
                  child: Text(" ●	While you are focused on taking care of your new baby, make sure that you are taking care of yourself as well.\n\n●	Take support of the family for taking care of your baby and yourself.\n\n●	Don’t expect a lot from yourself or feel guilty about anything.  - Your new role as a mother could be challenging at times but you will do great with time. \n\nTake your elder’s advice regarding baby’s massage. There would be some rituals and practices in your family which would make you feel nice and special, enjoy this phase.",
    style: TextStyle(fontSize: 17)),
                ),
              )
            ],
