...
class covid_eng extends StatefulWidget {
  @override
  _Diet_pre createState() => _Diet_pre();

}

class _Diet_pre extends State<covid_eng> {
          ...
          Row(
            ...
            children: [
              Container(
                ...
                child: Text(" COVID appropriate behaviour ",
            ...
            children: [
              SingleChildScrollView(
                child: Container(
                  ...
                  child: Text(" As you all know, from the last 2 years COVID infection keeps hitting back in our communities every now and then. You should take care of yourself there by following some basic hygiene practices like \n\n●	Wearing a mask when you are outside of your home or in the presence of people who do not live with you.\n\n●	Wash your hands frequently with soap and water/ use of hand sanitizer.\n\n●	Cover your mouth and nose with clean cotton cloth or with your elbow while coughing or sneezing.\n\n●	Maintain social distancing, that is 6 feet apart.\n\n●	Avoid contact with persons having symptoms e.g. fever, cough, cold.\n\n●	Don’t miss your regular follow up for antenatal care visits.  If you have cough, fever or breathlessness, immediately contact your doctor.",
                      style: TextStyle(fontSize: 17)),
                ),
              )
            ],
